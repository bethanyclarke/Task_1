...
%                 obj.R = 1/(2.2*N);
               ...
               % obj.DeltaL = 2.2*obj.R;
                obj.DeltaL = 44/(N-1); % To compare to the L-L length (final/first half don't affect dynamics)
...
%             obj.Kt = obj.Kb/10;
        ...
        function InternalForcesAndTorques(obj)
            ...
            %Force = 1.93*Bend*z/(L*L); 
            Force = 0.001 * Bend *z; %Tim actually used approximation of this value
            
            ForcesAndTorques(1:3,N) = ForcesAndTorques(1:3,N) + Force;
